...
**[Spgu](spgu)** - Also know as Soul's Pretty Good Updater (for Debian based systems)  
**[Gammaup](gammaup)** - Just a simple tool to boost your screen's display brightness when the brightness slider isn't enough  
**[Kulr](kulr)** - A simple Python color library using ANSI escape sequences to spruce up your Python scripts with ease  
**[Hashbrownies](hashbrownies)** - A simple tool for generating and scanning checksum files (ON HOLD)
